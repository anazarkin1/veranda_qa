...
export default class AnswersThread extends Component {
    constructor() {
        ...
        this.state = {
            answers: [
                {id: 1, created_at: ((+new Date()) / 1000) - 1000, content: 'ANswer 1', created_by: 'user1'},
                {id: 2, created_at: ((+new Date()) / 1000) - 5000, content: 'Answer 2', created_by: 'user1'},
                {id: 3, created_at: ((+new Date()) / 1000) - 10000, content: 'Answer 3', created_by: 'user2'}
            ]
        };
